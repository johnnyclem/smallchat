...
/** A conversation message with its embedding and metadata. */
export interface ConversationMessage {
  /** Unique identifier for this message (e.g. turn index or UUID). */
  id: string;
  /** Raw text content. */
  content: string;
  /** Pre-computed embedding vector (from the ONNX pipeline). */
